...
// ================= ANIMACIÓN =================
function animarPendulo(theta_arr, h) {
    ...
    function dibujar() {
        ...
        trail.push({ x, y });
        if (trail.length > 25)
            trail.shift(); // Mantener solo las últimas 25 posiciones
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    btn === null || btn === void 0 ? void 0 : btn.addEventListener("click", simular);
});
